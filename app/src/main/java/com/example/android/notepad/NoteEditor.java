...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        String   NTime   =   formatter.format(curDate);
        values.put(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE, NTime);
        values.put(NotePad.Notes.COLUMN_NAME_CREATE_DATE,NTime);
